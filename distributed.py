...
class DistributedBlockchain():
    ...
    def add_block(self):
        for i in range(1, self.total_chains+1):
            self.chain[i].addNewBlock()
...
def main_distributed():
    ...
    if peer == "Peer A":
        ...
        st.session_state.dist_blockchain.chain[1].render_chain(
            st.session_state.dist_blockchain.add_block)
    ...
    # st.sidebar.button(
    # "Add New Block", on_click=st.session_state.dist_blockchain.add_block)
